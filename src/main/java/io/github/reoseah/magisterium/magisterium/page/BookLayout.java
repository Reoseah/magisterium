...
public record BookLayout(
    ...
    public static class Builder {
        ...
        public Builder(BookProperties properties) {
            ...
            this.currentY = this.properties.pageY;
        }
        ...
        public boolean isNewPage() {
            return this.currentY == this.properties.pageY;
        }
        ...
        public int getCurrentX() {
            return this.currentPageIdx % 2 == 0 ? this.properties.pageLeftX : this.properties.pageRightX;
        }

        public int getNextX() {
            return this.currentPageIdx % 2 == 0 ? this.properties.pageRightX : this.properties.pageLeftX;
        }

        public int getMinY() {
            return this.properties.pageY;
        }

        public int getMaxY() {
            return this.properties.pageY + this.properties.pageHeight;
        }
