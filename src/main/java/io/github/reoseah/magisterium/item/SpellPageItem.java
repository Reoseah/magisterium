...
public class SpellPageItem extends Item {
    ...
    public static final Item AWAKEN_THE_FLAME = new SpellPageItem(createSettings().registryKey(AWAKEN_THE_FLAME_KEY), Identifier.of("magisterium:awaken_the_flame"));
    ...
    public static final Item QUENCH_THE_FLAME = new SpellPageItem(createSettings().registryKey(QUENCH_THE_FLAME_KEY), Identifier.of("magisterium:quench_the_flame"));
    ...
    public static final Item GLYPHIC_IGNITION = new SpellPageItem(createSettings().registryKey(GLYPHIC_IGNITION_KEY), Identifier.of("magisterium:glyphic_ignition"));
    ...
    public static final Item CONFLAGRATE = new SpellPageItem(createSettings().registryKey(CONFLAGRATE_KEY), Identifier.of("magisterium:conflagrate"));
    ...
    public static final Item ILLUSORY_WALL = new SpellPageItem(createSettings().registryKey(ILLUSORY_WALL_KEY), Identifier.of("magisterium:illusory_wall"));
    ...
    public static final Item COLD_SNAP = new SpellPageItem(createSettings().registryKey(COLD_SNAP_KEY), Identifier.of("magisterium:cold_snap"));
    ...
    public static final Item ARCANE_LIFT = new SpellPageItem(createSettings().registryKey(ARCANE_LIFT_KEY), Identifier.of("magisterium:arcane_lift"));
    ...
    public static final Item DISPEL_MAGIC = new SpellPageItem(createSettings().registryKey(DISPEL_MAGIC_KEY), Identifier.of("magisterium:dispel_magic"));

    private static Item.Settings createSettings() {
        return new Item.Settings().maxCount(16) //
                .component(DataComponentTypes.ITEM_NAME, Text.translatable("item.magisterium.spell_page"));
    }
